...
namespace Yalf.Reporting
{
    public class LogFilters : ILogFilters
    {
        ...
        public LogFilters(IEnumerable<string> includedKeysExpressionList, IEnumerable<string> excludedKeysExpressionList, bool ignoreCaseInFilter, bool hideEnterMethodLogs, bool hideExitMethodLogs, bool hideTimeStampInMethod, bool hideMethodParameters, bool hideMethodDuration, bool hideMethodReturnValue, bool singleLineFormat, DateTime timeStampFrom, DateTime timeStampTo, int threadId)
        {
